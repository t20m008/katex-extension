          ...
          if (multiLine) {
            ...
            if (colAlignLList.length > 1) {
              colAlignLList.forEach((colAlignL, i) => {
                ...
                cols.forEach(row => {
                  if (row.textContent.length > 0 && row.className === "mord" && row.clientHeight > 1 && row.parentElement.parentElement.parentElement.parentElement.parentElement.className.includes("col")) {
              ...
              colAlignLList.forEach(colAlignL => {
                ...
                cols.forEach(row => {
                  ...
                  //     )
                  // }
                  if (row.textContent.length > 0 && row.className === "mord" && row.clientHeight > 1 && row.parentElement.parentElement.parentElement.parentElement.parentElement.className.includes("col") && !row.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.classList.contains("matrix-mtable")) {
                    row.classList.add(`formula-${katexHTMLIndex}`, `row-${rightRowIndex}`, `right`);
                    rightRowIndex++;
                  }
                });
...
export { allCollapse, allExpand, katexCollapsible };
